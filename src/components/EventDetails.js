    ...
    <div className="register">
      <div className="register-content">
        ...
        <div className="register-box">
          ...
          <iframe src="https://discord.com/widget?id=1074365724400832532&theme=dark" width="500" height="350" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
        </div>
        <section>
          <div className="line">
            <hr />
